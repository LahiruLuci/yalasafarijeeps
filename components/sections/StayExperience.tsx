          ...
          <div className="lg:col-span-6 flex flex-col justify-center">
            ...
            <div className="space-y-12 pl-2 border-l-2 border-sunset-gold/20">
              ...
              <div className="relative group pl-10">
                ...
                <p className="text-safari-brown/60 leading-relaxed">
                  After an exhilarating day of tracking, unwind with sunset cocktails on the dunes. Feel the cool ocean breeze as the park transitions from the heat of the day to the mystery of the night.
                </p>
              </div>
