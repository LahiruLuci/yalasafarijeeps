        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            ...
            <p className="text-warm-sand/70 leading-relaxed max-w-sm mt-4">
              At {siteConfig.name}, we are more than just a safari company; we are your dedicated companions in exploring the untamed beauty of Yala National Park and beyond.
            </p>
            <div className="flex gap-4 mt-2">
              <a href={siteConfig.social.facebook} className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-sunset-gold hover:border-sunset-gold hover:text-deep-charcoal transition-all duration-300 transform hover:-translate-y-1">
              ...
              <a href={siteConfig.social.instagram} className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-sunset-gold hover:border-sunset-gold hover:text-deep-charcoal transition-all duration-300 transform hover:-translate-y-1">
              ...
              <a href={siteConfig.social.tripadvisor} className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-sunset-gold hover:border-sunset-gold hover:text-deep-charcoal transition-all duration-300 transform hover:-translate-y-1">
                ...
                <li key={link.name}>
                  <Link
                    ...
                    onClick={() => trackEvent("select_item", {
                      item_list_name: "footer_services",
                      item_name: link.name,
                      item_category: "safari_package"
                    })}
                    className="text-warm-sand/80 hover:text-sunset-gold transition-colors flex items-center gap-2 group"
                  >
                    <span className="w-1 h-1 bg-sunset-gold rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                    {link.name}
                  </Link>
